...
<a href="log.php"><font size= "6">Logout</font></a></br>
<div class="row">
  <div class="col-75">
    <div class="container">
      <form action="pay2.php" method="POST">
        ...
        <div class="row">
          <div class="col-50">
            ...
            <input type="text"  placeholder="542 W. 15th Street" required>
          ...
          <div class="col-50">
            ...
            <input type="text"   placeholder="John More Doe" required>
        ...
        <input type="submit" value="Pay the Bill" class="btn">
      </form>
    </div>
  </div>
