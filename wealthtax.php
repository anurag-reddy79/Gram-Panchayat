...
<center>
<header>
<h1><b><font color="black" size="8" class="fontstyle" >Wealth Tax</font></h1>

</header>
<section>
 <article>
   <form action="wealthdata.php" method="POST">
</br></br></br>
 <label class="vandana"><big><b>Permanent acc no*</b></big></label>
 &nbsp; &nbsp;<input type="text" name="paccno" required>
</br></br></br>
<input type="submit">
